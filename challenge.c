...
// FUNCTION PROTOTYPE
// =========================================================
void sparse_multiply(  // there was a bug here , you used double underscore (__) instead of single (_) , so I fixed it  
    int rows,
    int cols,
    const double* A,
    const double* x,
...
// =========================================================
// TODO: USER IMPLEMENTATION ---> DONE by WALEED
// =========================================================
void sparse_multiply(
    ...
    for (int i = 0; i < rows; i++) {
        ...
        // Mark where this row starts in CSR
        row_ptrs[i] = nnz;

        // Initialize output y[i]
        y[i] = 0.0;
